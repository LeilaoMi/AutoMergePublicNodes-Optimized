...
| 评分 | 协议 | 延迟(ms) | 来源 |
| --- | --- | --- | --- |
| 82.18 | hysteria2 | 356.9 | Au1rxx-base64 |
| 81.69 | shadowsocks | 234.4 | Au1rxx-base64 |
| 80.1 | shadowsocks | 289.9 | Au1rxx-base64 |
| 80.08 | shadowsocks | 260.7 | Au1rxx-base64 |
| 79.96 | shadowsocks | 309.4 | Au1rxx-base64 |

### Top 来源质量

| 来源 | 评分 | 测试数 | 建议 |
| --- | --- | --- | --- |
| zhangkai | 0.996 | 95 | prefer |
| Au1rxx-base64 | 0.887 | 257 | prefer |
| Surfboard-tg-mixed | 0.446 | 8 | observe |
| DeltaKronecker-all | 0.436 | 801 | observe |
| mheidari-all | 0.305 | 10 | observe |
